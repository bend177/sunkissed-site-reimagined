/**
 * Apple Pay express checkout button. Shopify's hosted checkout offers Apple Pay
 * as an accelerated payment method, so this opens the same checkout URL.
 */
export function ApplePayButton({
  ...
  return (
    <button
      ...
      className={`flex w-full items-center justify-center gap-1 bg-ink py-4 text-background ${className}`}
    >
      <svg viewBox="0 0 170 170" aria-hidden="true" className="h-[18px] w-[18px] fill-current">
