...
function Gallery({
  ...
  return (
    <div className="image-bg relative aspect-[3/4] overflow-hidden">
      ...
      {sale && (
        <span className="absolute left-2 top-2 inline-flex items-center gap-0.5 rounded-full bg-white px-2 py-1 text-[8px] font-normal uppercase tracking-[0.18em] text-black shadow-[0_1px_3px_rgba(0,0,0,0.18)]">
