              ...
              <>
                <span
                  className={`size-1 rounded-full transition-colors ${
                    index === 0 ? "bg-foreground" : "bg-foreground/25"
                  }`}
                />
                {images.length > 2 && (
                  <span
                    className={`h-1 w-2 rounded-full transition-colors ${
                      index >= 1 ? "bg-foreground" : "bg-foreground/25"
                    }`}
                  />
                )}
              </>
      ...
      <div className="group relative">
        ...
        {!showMeta && (
          <button
            ...
            className="absolute bottom-2 right-2 flex size-5 items-center justify-center rounded-[4px] border border-foreground bg-background/85 text-foreground transition-opacity hover:opacity-70 lg:hidden"
          >
      ...
      <div className="mt-2.5">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            ...
            aria-label={`Quick add ${product.title}`}
            onClick={() => setOpen(true)}
            className="mr-1.5 flex size-3.5 shrink-0 items-center justify-center self-center rounded-[4px] border border-foreground text-foreground transition-opacity hover:opacity-70 lg:hidden"
          >
