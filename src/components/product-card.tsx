...
function Gallery({
  ...
  return (
    <div className="image-bg relative aspect-[3/4] overflow-hidden">
      ...
      {sale && (
        <span className="absolute left-2 top-2 inline-flex items-center gap-1 rounded-full bg-white px-2 py-0.5 text-[9px] font-semibold uppercase tracking-[0.16em] text-black shadow-[0_1px_3px_rgba(0,0,0,0.18)]">
          <span className="size-1.5 rounded-full bg-[#BA2C33]" />
          Sale
        </span>
      )}
    </div>
