        ...
        <section className="relative">
          <div className="relative h-[78vh] min-h-[520px] w-full overflow-hidden md:h-[92vh]">
            ...
            <div className="absolute inset-x-0 bottom-0 px-4 pb-8 md:px-6 md:pb-12">
              ...
              <div className="rise mt-3 flex items-end justify-between gap-3 md:gap-6">
                <h1 className="display whitespace-nowrap text-[10.5vw] leading-[0.95] text-background md:text-[7vw]">
                  Designed to seduce
                </h1>
                <Link
                  to="/shop"
                  search={{ c: "new" }}
                  className="shrink-0 whitespace-nowrap pb-1 text-sm lowercase text-background md:text-base"
                >
                  shop now &rarr;
                </Link>
              </div>
