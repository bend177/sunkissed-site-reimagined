    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <div className="grid grid-cols-1 gap-0 md:grid-cols-[1fr_340px] md:gap-6 md:px-6 lg:grid-cols-[1fr_420px] lg:gap-10">
          ...
          <div className="flex snap-x snap-mandatory overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:ml-auto md:mr-2 md:self-start md:grid md:max-w-[420px] md:grid-cols-2 md:gap-1 md:overflow-visible">
            {gallery.map((src, i) => (
              <div
                key={src + i}
