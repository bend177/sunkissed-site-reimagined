...
function ColorGroup({
  ...
  return (
    <div className="mt-5">
      ...
      <div className="mt-2 flex flex-wrap gap-1.5 lg:grid lg:max-w-none lg:flex-none lg:grid-cols-10 lg:justify-start lg:justify-items-start">
        {items.map((s) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <div className="grid grid-cols-1 gap-0 md:grid-cols-[2fr_1fr] md:gap-8 md:px-6 lg:grid-cols-[1fr_460px] lg:gap-10">
          {/* Gallery - swipeable single column on mobile, 2-up grid on tablet and desktop */}
